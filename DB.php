...
Class DB {
    ...
    public $host = "mysql.hostinger.com.br"; //host ou ip do banco
    public $base = "u747973955_agca1"; //nome do banco 
    public $user = "u747973955_ghd32";//""; //nome do usuario 
    public $pass = "gui8811";//""; //senha do banco
    public $con;
    public $sql;
    public $res;
    public $data;
